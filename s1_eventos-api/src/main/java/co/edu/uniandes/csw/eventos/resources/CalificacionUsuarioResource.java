...
import co.edu.uniandes.csw.eventos.dtos.UsuarioDetailsDTO;
...
public class CalificacionUsuarioResource {
    ...
    @POST
    @Path("{usuariosId: \\d+}")
    public UsuarioDetailsDTO getUsuario(@PathParam("calificacionesId") Long calificacionesId, @PathParam("usuariosId") Long usuariosId) throws BusinessLogicException{
