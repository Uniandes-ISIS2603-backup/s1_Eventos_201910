...
import co.edu.uniandes.csw.eventos.resources.AgendaResource;
...
public class AgendaIT {
    ...
    private static final String COLLECTION = "Agenda-Test.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(AgendaResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
