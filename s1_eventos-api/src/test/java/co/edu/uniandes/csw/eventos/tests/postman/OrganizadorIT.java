...
import co.edu.uniandes.csw.eventos.resources.OrganizadorResource;
...
public class OrganizadorIT {
    ...
    private static final String COLLECTION = "Organizador-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(OrganizadorResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
