...
import co.edu.uniandes.csw.eventos.resources.UsuarioCalificacionesResource;
...
public class UsuarioCalificacionesIT {
    
     
    private static final String COLLECTION = "UsuarioCalificaciones-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(UsuarioCalificacionesResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
