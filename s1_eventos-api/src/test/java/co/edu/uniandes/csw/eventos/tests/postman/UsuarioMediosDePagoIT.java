...
import co.edu.uniandes.csw.eventos.resources.UsuarioMediosDePagoResource;
...
public class UsuarioMediosDePagoIT {
    
     private static final String COLLECTION = "UsuarioMediosDePago-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(UsuarioMediosDePagoResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
