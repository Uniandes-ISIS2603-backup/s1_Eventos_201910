...
import co.edu.uniandes.csw.eventos.resources.FacturaResource;
...
public class FacturaIT {
    ...
    private static final String COLLECTION = "Factura-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(FacturaResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
