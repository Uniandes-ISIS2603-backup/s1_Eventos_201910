...
import co.edu.uniandes.csw.eventos.resources.EventoPatrocinadorResource;
...
public class EventoPatrocinadorIT {

           
    private static final String COLLECTION = "EventoPatrocinador-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(EventoPatrocinadorResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
