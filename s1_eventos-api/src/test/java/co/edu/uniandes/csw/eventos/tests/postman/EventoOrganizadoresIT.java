...
import co.edu.uniandes.csw.eventos.resources.EventoOrganizadoresResource;
...
public class EventoOrganizadoresIT {
    
              
    private static final String COLLECTION = "EventoOrganizadores-Tests.postman_collection";

    @Deployment(testable = true)
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                // Se agrega las dependencias
                .addAsLibraries(Maven.resolver().loadPomFromFile("pom.xml")
                        .importRuntimeDependencies().resolve()
                        .withTransitivity().asFile())
                // Se agregan los compilados de los paquetes de servicios
                .addPackage(EventoOrganizadoresResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(OrganizadorDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
