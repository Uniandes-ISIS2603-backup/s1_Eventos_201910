...
import co.edu.uniandes.csw.eventos.resources.UbicacionResource;
...
public class UbicacionIT {
      
    private static final String COLLECTION = "Ubicacion-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(UbicacionResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(UbicacionDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
