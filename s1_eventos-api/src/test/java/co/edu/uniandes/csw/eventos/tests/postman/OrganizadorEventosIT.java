...
import co.edu.uniandes.csw.eventos.resources.OrganizadorEventosResource;
...
public class OrganizadorEventosIT {
    
       
    private static final String COLLECTION = "OrganizadorEventos-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(OrganizadorEventosResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
