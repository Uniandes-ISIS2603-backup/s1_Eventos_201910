...
import co.edu.uniandes.csw.eventos.resources.EntradaResource;
...
public class EntradaIT {
    
        private static final String COLLECTION = "EntradaResourceTest.postman_collection";
       ...
       @Deployment(testable = true)
        ...
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(EntradaResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
