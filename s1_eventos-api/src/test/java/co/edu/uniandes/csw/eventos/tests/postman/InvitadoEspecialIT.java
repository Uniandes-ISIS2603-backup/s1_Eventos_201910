...
import co.edu.uniandes.csw.eventos.resources.InvitadoEspecialResource;
...
public class InvitadoEspecialIT {
    
      
    private static final String COLLECTION = "InvitadoEspecial Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(InvitadoEspecialResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(InvitadoEspecialDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
