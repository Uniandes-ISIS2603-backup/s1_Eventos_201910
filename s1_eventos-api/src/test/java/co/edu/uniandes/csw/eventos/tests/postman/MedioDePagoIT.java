...
import co.edu.uniandes.csw.eventos.resources.MedioDePagoResource;
...
public class MedioDePagoIT {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(MedioDePagoResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
