...
import co.edu.uniandes.csw.eventos.resources.UsuarioEventosResource;
...
public class UsuarioFacturasIT {
  
           
       
    private static final String COLLECTION = "UsuarioFacturas-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(UsuarioEventosResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
