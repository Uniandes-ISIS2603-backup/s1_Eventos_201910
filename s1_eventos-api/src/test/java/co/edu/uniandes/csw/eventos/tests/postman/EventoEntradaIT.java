...
import co.edu.uniandes.csw.eventos.resources.EventoCalificacionResource;
import co.edu.uniandes.csw.postman.tests.PostmanTestBuilder;
import java.io.File;
import java.io.IOException;
import org.jboss.arquillian.container.test.api.Deployment;
import org.jboss.arquillian.container.test.api.RunAsClient;
import org.junit.runner.RunWith;import org.jboss.arquillian.junit.Arquillian;
...
public class EventoEntradaIT {
    
     private static final String COLLECTION = "EventoEntradaResourceTest.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(EventoCalificacionResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
