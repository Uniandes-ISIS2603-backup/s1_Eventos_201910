...
import co.edu.uniandes.csw.eventos.resources.UsuarioEntradasResource;
...
public class UsuarioEntradasIT {
    
    private static final String COLLECTION = "UsuarioEntradas-Tests.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s1_eventos-api.war")//War del modulo api
                ...
                .addPackage(UsuarioEntradasResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
                .addPackage(EntradaDTO.class.getPackage()) //No importa cual dto usar, lo importante es agregar el paquete.
