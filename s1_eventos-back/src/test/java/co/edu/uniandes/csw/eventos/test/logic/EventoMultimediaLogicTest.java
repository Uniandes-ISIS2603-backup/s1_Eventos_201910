...
public class EventoMultimediaLogicTest {
    ...
    public void addMultimediaTest() throws BusinessLogicException {
        ...
        MultimediaEntity multimediaEntity = eventoMultimediasLogic.addMultimedia(evento.getId(), newMultimedia.getId());
        ...
        MultimediaEntity lastMultimedia = new MultimediaEntity();
        lastMultimedia = eventoMultimediasLogic.getMultimedia(evento.getId(), newMultimedia.getId());
    ...
    public void removeMultimediaTest() {
        for (MultimediaEntity multimedia : data) {
            eventoMultimediasLogic.removeMultimedia(evento.getId(), multimedia.getId());
        }
        Assert.assertTrue("error hay " + eventoMultimediasLogic.getMultimediaes(evento.getId()).size(), eventoMultimediasLogic.getMultimediaes(evento.getId()).isEmpty());
    }
}
