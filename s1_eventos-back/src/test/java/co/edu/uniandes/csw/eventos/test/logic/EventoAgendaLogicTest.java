...
/**
 * Pruebas de logica de la relacion Evento - Agendas
 *
 * @evento Paula Molina
 */
...
public class EventoAgendaLogicTest {
    ...
    public void addAgendaTest() throws BusinessLogicException {
        ...
        AgendaEntity lastAgenda = eventoAgendasLogic.getAgenda(evento.getId(), newAgenda.getId());
    ...
    public void removeAgendaTest() {
        ...
        Assert.assertTrue(eventoAgendasLogic.getAgendas(evento.getId()).isEmpty());
    }
}
