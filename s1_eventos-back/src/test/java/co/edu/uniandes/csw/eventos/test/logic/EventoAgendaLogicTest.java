...
public class EventoAgendaLogicTest {
    ...
    public void addAgendaTest() throws BusinessLogicException {
        ...
        AgendaEntity lastAgenda = new AgendaEntity();
        lastAgenda = eventoAgendasLogic.getAgenda(evento.getId(), newAgenda.getId());

        Assert.assertEquals(lastAgenda.getId(), newAgenda.getId());
        Assert.assertEquals(lastAgenda.getNombre(), newAgenda.getNombre());
    }
    ...
    public void removeAgendaTest() {
        ...
        Assert.assertTrue("error hay "+ eventoAgendasLogic.getAgendas(evento.getId()).size() ,eventoAgendasLogic.getAgendas(evento.getId()).isEmpty());
    }
}
